...
// Задача 1.
const num = +prompt("Проверка на чётность: ");
...
// // Задача 3.
let username = prompt("Ввдите логина: admin");
let password = 0;

if (username == "admin" || username == "user") {
    password = prompt("Ввдите пароль: 123456");
    if (password == "123456") {
        alert("Вход разрешён");
    } else {
...
let pkgWeight = +prompt("Укажите вес посылки в килограммах: ");
let pkgType = prompt(
...
if (pkgWeight <= 0) {
    ...
    if (pkgWeight < 1) {
        cost = 5;
    } else if (pkgWeight >= 1 && pkgWeight <= 5) {
        cost = 10;
    } else {
        cost = 15;
    }
    ...
    alert(`Стоимость вашей досатавки будет ${cost}$.`);
}
